...
test_Proof = do
    ...
    pure
        [ testGroup
            "Encoding"
            [ testCase "proof" $
                encodeHexLazy proofEncoding @=? encodeHexLazy (Bin.encode proof)
            , testCase "proof with splits" $
                encodeHexLazy proofSplitEncoding @=? encodeHexLazy (Bin.encode proofWithSplits)
            ]
        , testGroup
            "Decoding"
            [ testCase "proof" $
                proof @=? Bin.decode proofEncoding
            , testCase "proof with splits" $
                proofWithSplits @=? Bin.decode proofSplitEncoding
            ]
        ]
  where
    pubKey = xOnlyPubKey $ Bin.decode $ fromJust $ decodeHexLazy "a0afeb165f0ec36880b68e0baabd9ad9c62fd1a69aa998bc30e9a346202e078f"
    txMerkleProof = Bin.decode $ fromJust $ decodeHexLazy ""
    asset@Asset.Asset{assetGenesis = Asset.Genesis{genesisOutpoint}} = Bin.decode $ fromJust $ decodeHexLazy ""
    taroProof = Bin.decode $ fromJust $ decodeHexLazy "00010001220000ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"
    taroAssetProof = Just $ Bin.decode $ fromJust $ decodeHexLazy "00010001201ac000c58c1ce3aa048ea56210367a3cba00db3c3db339b87af37393a8aabb4102220000ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"
